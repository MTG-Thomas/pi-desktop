...
import { createAppBusBroker, registerBusHandlers, startBusFileBridge } from './ipc/bus-handlers'
...
export function registerIpcHandlers(
  ...
  const busBroker = createAppBusBroker(ctx)
  registerBusHandlers(ctx, busBroker)
  startBusFileBridge(ctx, busBroker)
